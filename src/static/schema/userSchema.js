...
userSchema.methods.updateCurrency = function( gold, silver, copper, type )
{
    update( "copper", "silver", "gold", copper, silver, gold, type == "wallet" ? this.wallet : this.bank );
}
